...
class SplitAutomation(hass.Hass):
    ...
    def initialize(self):
        ...
        self.split_dir = self.args.get("split_directory", "/homeassistant/custom_configs/automations")
        self.automations_file = self.args.get("automations_file", "/homeassistant/automations.yaml")
